  ...
  var Banner = {
    init: function init() {
      ...
      function animatePack() {
        dom.animation.classList.remove('invisible');
        var tl = new TimelineMax();
        tl.add("start").from("#shadow", 1, {
          autoAlpha: 0,
          x: "-=35",
          ease: ease
        }, "start").from("#fruits", 1, {
          ...
          rotation: -90,
          ease: ease
        }, "start").from("#oats,#front-oat", 1, {
          scale: 0,
          ease: ease,
          force3D: false
        }, "start") // .from("#front-oat",1,{autoAlpha:0, scale:0.5,ease:ease,force3D:false}, "start")
        .from("#leaf", 1, {
          scale: 0,
          ease: ease
        }, "-=0.8").to("#oats,#front-oat", 4, {
          scale: 1,
          force3D: false
        }, "-=1");
      }
      ...
      function frame0() {
        ...
        tl.from("#txt1", 1.5, {
          ...
          x: "-=300",
          ease: ease
        }).call(animatePack).from("#txt2", 1.5, {
          autoAlpha: 0,
          x: "-=300",
          ease: ease
        }, "+=1").from("#txt3", 1.5, {
      ...
      function addRollover() {
        dom.ad_content.addEventListener('mouseenter', function () {// Remove this comment
        });
